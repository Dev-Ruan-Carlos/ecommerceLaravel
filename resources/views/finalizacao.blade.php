...
@method('POST')
    <div class="fundoclaro flex-jc flex-ac flex-c">
        ...
        <div class="tela-pagamento flex-c p-2 mb-1">
            ...
            <div class="flex-c mt-05 h-100 flex-jb">
                <table class="w-100">
                    <tr class="w-100" style="border-bottom: 0px solid white !important;">
                    ...
                    @foreach ($pedido->pedidoItens as $p)
                        <tr class="w-100 mt-05" style="border-bottom: 0px solid white !important;">
